...
def get_sequence_length(number, list):
    """
    Pomoćna funkcija u primeru collatz_sequence_list2
...
if __name__ == '__main__':
    ...
    number, seq_length = collatz_sequence_list()
    end_time = time.time()
    ...
    start_time = time.time()
    number, seq_length = collatz_sequence_list2()
    end_time = time.time()
    elapsed_time = end_time - start_time
